/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 1efcbc88ee9835f91361477e93faa6b9)
// Runtime types generated with workerd@1.20260420.1 2026-04-07 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		NEXT_PUBLIC_SITE_URL: "https://vcontheroad.cv";
		PAYLOAD_SECRET: string;
		WORKER_SELF_REFERENCE: Service<typeof import("./src/index").default>;
	}
	interface Env {
		KV: KVNamespace;
		R2: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "PAYLOAD_SECRET">> {}
}
